...
def last_update():
    ...
    return updated_date.text

chartdata_df = load_data()
...
def load_data2():
    ...
    chartdata_df2['Positivity rate'] = (chartdata_df2['newCase']/chartdata_df['newTest'])*100
    ...
    return chartdata_df2

chartdata_df2 = load_data2()
